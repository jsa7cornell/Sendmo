...
import { clearFlow } from "@/lib/recipientFlowStorage";
...
// Entry to /onboarding. One job: start a new shipment. Any stored draft is
// cleared first — the provider hydrates whatever loadPersisted returns, so
// leaving it in storage would silently rehydrate the last shipment's
// addresses and resolved sender into a "new" flow. (2026-08-23: the
// Continue / Start fresh resume offer is gone — clicking to create a
// shipment always starts anew.)
