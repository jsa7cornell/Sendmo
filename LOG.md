...
**Measured.** Unit 743 passing (69 files; +15 across 3 new files). tsc clean. E2e 186 passed / 10 skipped / 0 failed over two full repeats. The first run after the identity removal was 28 failed / 69 passed — all traceable to specs filling `#recipient-email` on a step that no longer has it.
