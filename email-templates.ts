...
export const emailTemplates = {
  ...
  label_created_receiver: {
    subject: (itemDescription: string) => `Your shipping label for "${itemDescription}" is ready`,
    template: `
  ...
  label_printed_receiver: {
    subject: (itemDescription: string) => `Your item "${itemDescription}" has been shipped!`,
    template: `
  ...
  in_transit_receiver: {
    subject: (itemDescription: string) => `Your package "${itemDescription}" is on the way`,
    template: `
  ...
  delivered_receiver: {
    subject: (itemDescription: string) => `Delivered: "${itemDescription}"`,
    template: `
  ...
  label_ready_sender: {
    subject: (itemDescription: string, receiverName: string) => `Print your shipping label for ${receiverName}`,
    template: `
  ...
  shipment_confirmed_sender: {
    subject: (itemDescription: string) => `Thank you for shipping "${itemDescription}"`,
    template: `
  ...
  implicit_verification_tracking: {
    // No subject - this is just a tracking pixel / link click event
    // User clicks tracking link → we mark them as "linked" verification status
    // No email sent, just backend logic
  },
  
  explicit_verification: {
    subject: 'Verify your SendMo account',
    template: `
