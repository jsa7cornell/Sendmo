...
const SCHEMA: Record<string, string[]> = {
  ...
  // recipient_user_id.
  sendmo_links: ["created_at","expires_at","funder","height_in","id","is_test","last_decline_email_at","length_in","link_type","max_price_cents","max_shipments","notes","origin_address_id","preferred_carrier","preferred_speed","recipient_address_id","sender_name","short_code","size_hint","status","updated_at","user_id","weight_hint_oz","width_in"],
